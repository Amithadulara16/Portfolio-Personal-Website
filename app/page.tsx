...
/>
      ...
      {/* ══ FOOTER ══ */}
      <footer style={{ position: "relative", zIndex: 10, borderTop: "1px solid rgba(56,189,248,0.08)", padding: "40px 24px", textAlign: "center" }}>
        <p style={{ color: "#334155", fontSize: "0.88rem" }}>
          Built with{" "}
          <span style={{ color: "#38BDF8" }}>Next.js</span>,{" "}
          <span style={{ color: "#38BDF8" }}>TypeScript</span> &amp;{" "}
